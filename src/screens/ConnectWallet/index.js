          ...
          <div className={styles.wrapper}>
            ...
            <div className={styles.item}>
              ...
              <div className={styles.text}>
                Please take a few minutes to read and understand <span>Stacks Terms of Service</span>. To continue,
                you’ll need to accept the terms of services by checking the boxes.
              </div>
