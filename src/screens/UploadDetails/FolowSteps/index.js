        ...
        <div className={styles.item}>
          <div className={styles.head}>
            ...
            <div className={styles.details}>
              ...
              <div className={styles.text}>Sign sell order using your wallet</div>
            </div>
          </div>
          <button className={cn('button disabled', styles.button)}>Start now</button>
        </div>
        <div className={styles.item}>
          <div className={styles.head}>
            <div className={styles.icon}>
        ...
        <div className={styles.item}>
          <div className={styles.head}>
            ...
            <div className={styles.details}>
              ...
              <div className={styles.text}>Sign lock order using your wallet</div>
            </div>
          </div>
