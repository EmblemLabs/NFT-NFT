    ...
    <>
      <div className={cn(styles.control, className)}>
        ...
        <div className={styles.btns}>
          <button className={cn('button', styles.button)} onClick={() => setVisibleModalPurchase(true)}>
            Purchase now
          </button>
          <button className={cn('button-stroke', styles.button)} onClick={() => setVisibleModalBid(true)}>
            Place a bid
          </button>
        </div>
        <div className={styles.btns}>
          <button className={cn('button-stroke', styles.button)}>View all</button>
          <button className={cn('button', styles.button)} onClick={() => setVisibleModalAccept(true)}>
            Accept
          </button>
        </div>
        <div className={styles.text}>
          Service fee <span className={styles.percent}>1.5%</span> <span>2.563 ETH</span> <span>$4,540.62</span>
        </div>
        <div className={styles.foot}>
          <button className={cn('button', styles.button)} onClick={() => setVisibleModalSale(true)}>
            Put on sale
          </button>
        </div>
