...
const filters = ['Sales', 'Listings', 'Bids', 'Burns', 'Followings', 'Likes', 'Purchase', 'Transfers'];
      ...
      <div className={cn('section-pt80', styles.body)}>
        <div className={cn('container', styles.container)}>
          <div className={styles.top}>
            ...
            <button className={cn('button-stroke button-small mobile-hide', styles.button)}>Mark all as read</button>
            <button
          ...
          <div className={styles.row}>
            ...
            <button className={cn('button-stroke button-small mobile-show', styles.button)}>Mark all as read</button>
            <Filters
